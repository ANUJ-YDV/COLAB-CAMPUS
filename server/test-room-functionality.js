...
const TOKEN_1 = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2OGZjZTc4ZTA0YTYwOTRlZWIzYWE4ZWEiLCJpYXQiOjE3NjE2ODYzODAsImV4cCI6MTc2MTc3Mjc4MH0.7NqTO0oQObnJuZrlxTxXeZ-NylLTyEkm8EBeo7NM8kk"; // anuj@example.com
const TOKEN_2 = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2OGZjZWUyZDY3MDIxMDRkZTljYzZkZjciLCJpYXQiOjE3NjE2ODYzODAsImV4cCI6MTc2MTc3Mjc4MH0.bK71LuIjTSS-n-YEemz0eXGm9IK_ugGRvJm9-rzSy6Q"; // test@example.com
  ...
  return new Promise((resolve) => {
    ...
    socket.on("joined_project", (data) => {
      ...
      logTest(
        "Test 1",
        true,
        `Joined project: ${data.projectName || data.projectId}`
      );
